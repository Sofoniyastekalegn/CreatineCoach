...
How It Works
Upload PDF → Chunked (~800 chars, 200 overlap) → Embeddings (Voyage) → Pinecone

Ask question → Retrieve top-6 chunks → Gemini generates grounded answer with citations

Session memory (JSON files) enables follow-up questions
